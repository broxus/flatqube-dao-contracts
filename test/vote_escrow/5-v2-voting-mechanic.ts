...
describe("Vote Escrow v2 normalizing mechanics update", async function () {
    let user: Account;
    let owner: Account;
    ...
    describe('Setup contracts', async function () {
        ...
        it('Deploy Vote Escrow', async function () {
            ...
            // 1 - send overflow to treasury
            await vote_escrow.setVotingNormalizingType(1);
        });
    });

    describe('Running scenarios', async function () {
        const epoch_distribution_amount = 1000000;
        ...
        describe('Making deposits & whitelisting gauges & send distribution QUBEs', async function () {
            ...
            it('Whitelisting gauges', async function () {
                ...
                const expected_bal = 2000 + epoch_distribution_amount * 4;
        ...
        describe('Case #2 - excess, low and valid vote counts', async function () {
            ...
            it('Voting', async function () {
                ...
                votes[gauges[2].address.toString()] = Math.floor(Number(ve_balances._veQubeBalance) * 0.1); // 10% => 10%
            ...
            it('End voting', async function () {
                ...
                let treasury_votes = Math.floor(total_votes * 0.3); // 24% + 5% + 1%

                const farming_distribution = Math.floor(epoch_distribution_amount * 0.8);
                let treasury_bonus = Math.floor(treasury_votes * farming_distribution / total_votes);
                ...
                expect(votes_map[gauges[2].address.toString()]).to.be.eq((votes[gauges[2].address.toString()]).toString());
                ...
                const max_distribution = Math.floor(farming_distribution * share)
                const expected_gauge_2_dist = Math.floor(farming_distribution * (votes[gauges[2].address.toString()] / total_votes));
                ...
                expect(distribution_map[gauges[2].address.toString()]).to.be.eq(expected_gauge_2_dist.toString());
                ...
                const expected_supply = Number(supply) - (max_distribution * 2 + expected_gauge_2_dist) - expected_team - expected_treasury;
        ...
        describe('Case #3 - gauge removed from whitelist because of downtime', async function () {
            ...
            it('Voting', async function () {
                ...
                votes[gauges[0].address.toString()] = Math.floor(Number(ve_balances._veQubeBalance) * 0.54); // 54% => 30%
                votes[gauges[1].address.toString()] = Math.floor(Number(ve_balances._veQubeBalance) * 0.35); // 35% => 30%
                votes[gauges[2].address.toString()] = Math.floor(Number(ve_balances._veQubeBalance) * 0.1); // 10%
                votes[gauges[3].address.toString()] = Math.floor(Number(ve_balances._veQubeBalance) * 0.01); // 1% => 0%
            ...
            it('End voting', async function () {
                ...
                const share = max_votes / total_votes;
                const max_distribution = Math.floor(Math.floor(epoch_distribution_amount * 0.8) * share);
                const expected_gauge_2_dist = Math.floor(farming_distribution * (votes[gauges[2].address.toString()] / total_votes));

                expect(distribution_map[gauges[0].address.toString()]).to.be.eq(max_distribution.toFixed(0));
                expect(distribution_map[gauges[1].address.toString()]).to.be.eq(max_distribution.toFixed(0));
                expect(distribution_map[gauges[2].address.toString()]).to.be.eq(expected_gauge_2_dist.toFixed(0));
                should.not.exist(distribution_map[gauges[3].address.toString()]);
        ...
        describe('Case #4 - all votes are low/excess', async function () {
            ...
            it('End voting', async function () {
                ...
                let treasury_bonus = Math.floor(exceeded_votes * Math.floor(epoch_distribution_amount * 0.8) / total_votes);
        ...
        describe('Case #5 - no one voted', async function () {
            ...
            it('End voting', async function () {
                ...
                let treasury_bonus = Math.floor(epoch_distribution_amount * 0.8);
