    ...
    describe('Setup contracts', async function() {
        it('Deploy users', async function() {
            ...
            for (const i of [1,2,3,4]) {
                ...
                gauges.push(account);
                // this is not real gauge, we will always get 60 error on token receive
                locklift.tracing.allowCodesForAddress(account.address, {compute: [60]})
            }
        });
    ...
    describe('Running scenarios', async function() {
        describe('Making deposits & whitelisting gauges & send distribution QUBEs', async function() {
            ...
            it('Whitelisting gauges', async function() {
                ...
                const whitelisted = await vote_escrow.whitelistedGauges();
                for (const gauge of gauges) {
        ...
        describe('Case #2 - excess votes and low votes', async function() {
            let votes = {};
            let total_votes;
