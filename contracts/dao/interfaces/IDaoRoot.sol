...
interface IDaoRoot is ActionStructure, ProposalConfigurationStructure, ProposalStates, DaoPlatformTypes {
    ...
    event VoteEscrowRootUpdated(address oldRoot, address newRoot);
    ...
    function getVoteEscrowRoot() external responsible view returns (address);
    ...
    function expectedVoteEscrowAccountAddress(address accountOwner) external responsible view returns (address);
    ...
    function setVoteEscrowRoot(address newRoot) external;
